...
Ydts: Saída desejada para o conjunto Xts;
%}
function [Xtr,Ydtr,Xts,Ydts] = processaSeries(datasetTreinamento, datasetTeste, lag)
	[Xtr,Ydtr,datasetNormTr] = processaDatasetTreinamento(datasetTreinamento, lag);
